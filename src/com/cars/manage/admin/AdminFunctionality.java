package com.cars.manage.admin;

import com.cars.manage.car.Car;
import com.cars.manage.car.CarAdd;
import com.cars.manage.car.CarDeletion;
import com.cars.manage.car.CarDisplay;
...
import com.cars.manage.buy.SoldCarDisplay;
        ...
        while (true)
        {
            ...
            if(choice.equals("1"))
            {
                ...
                if(addChoice.equals("1")){
                    ...
                    CarAdd carAdd = new CarAdd(car);
                    boolean res = carAdd.insertCarToDatabase();
                    if(res)
                    {
